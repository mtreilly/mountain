...
INSERT OR IGNORE INTO indicators (code, name, unit, source, source_code, category) VALUES
    ...
    ('ELECTRICITY_GEN_WIND', 'Electricity generation (wind)', 'TWh', 'Our World in Data', 'owid-energy-data:wind_electricity', 'energy'),
    ('ELECTRICITY_GEN_COAL', 'Electricity generation (coal)', 'TWh', 'Our World in Data', 'owid-energy-data:coal_electricity', 'energy'),
