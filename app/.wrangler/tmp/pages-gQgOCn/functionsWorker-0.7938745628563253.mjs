...
var init_convergence = __esm({
  "api/convergence.ts"() {
    ...
    onRequestGet3 = /* @__PURE__ */ __name(async (context) => {
      ...
      const getLatestValue = /* @__PURE__ */ __name(async (countryCode) => {
        const result = await DB.prepare(
...
var UK_TL2_REGIONS, US_TL2_REGIONS, DE_TL2_REGIONS, FR_TL2_REGIONS, ALL_TL2_REGIONS, COUNTRIES_WITH_REGIONS, STATIC_REGION_DATA;
...
var init_resvg_wasm = __esm({
  "../node_modules/.pnpm/@resvg+resvg-wasm@2.6.2/node_modules/@resvg/resvg-wasm/index.mjs"() {
    ...
    cachedTextEncoder = typeof TextEncoder !== "undefined" ? new TextEncoder("utf-8") : { encode: /* @__PURE__ */ __name(() => {
    ...
    BBoxFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
    ...
    RenderedImageFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
    }, "register"), unregister: /* @__PURE__ */ __name(() => {
    ...
    ResvgFinalization = typeof FinalizationRegistry === "undefined" ? { register: /* @__PURE__ */ __name(() => {
    }, "register"), unregister: /* @__PURE__ */ __name(() => {
    ...
    onRequestGet6 = /* @__PURE__ */ __name(async (context) => {
      ...
      if (isRegionalMode) {
       ...
       WHERE iso_alpha3 IN (?, ?)`
        ...
        const countryName = /* @__PURE__ */ __name((iso3) => (countries.results || []).find((c) => c.iso_alpha3 === iso3)?.name || iso3, "countryName");
      ...
      const chart = (() => {
        ...
        const toX = /* @__PURE__ */ __name((year) => chartInner.x + (year - minYear) / xRange * chartInner.width, "toX");
        const toY = /* @__PURE__ */ __name((value) => chartInner.y + chartInner.height - value / yMax * chartInner.height, "toY");
...
// ../.wrangler/tmp/bundle-nkzrU0/middleware-loader.entry.ts
init_functionsRoutes_0_1926610656477008();

// ../.wrangler/tmp/bundle-nkzrU0/middleware-insertion-facade.js
init_functionsRoutes_0_1926610656477008();

// ../node_modules/.pnpm/wrangler@4.59.2/node_modules/wrangler/templates/pages-template-worker.ts
init_functionsRoutes_0_1926610656477008();
...
//# sourceMappingURL=functionsWorker-0.7938745628563253.mjs.map
