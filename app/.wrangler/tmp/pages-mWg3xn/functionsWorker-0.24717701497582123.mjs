    ...
    onRequestGet6 = /* @__PURE__ */ __name(async (context) => {
     ...
     WHERE i.code = ?
      ...
      const spark = (() => {
        ...
        const toX = /* @__PURE__ */ __name((year) => x0 + pad.x + (year - minYear) / xRange * (W - pad.x * 2), "toX");
        const toY = /* @__PURE__ */ __name((value) => y0 + pad.y + (1 - (value - minVal) / yRange) * (H - pad.y * 2), "toY");
...
// ../.wrangler/tmp/bundle-mcGnGP/middleware-loader.entry.ts
init_functionsRoutes_0_2283504560347427();

// ../.wrangler/tmp/bundle-mcGnGP/middleware-insertion-facade.js
init_functionsRoutes_0_2283504560347427();
...
//# sourceMappingURL=functionsWorker-0.24717701497582123.mjs.map
