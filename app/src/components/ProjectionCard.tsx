        ...
        <div className="flex justify-end gap-2 mt-2 no-print">
          {onShareCard && (
            <button
              type="button"
              onClick={onShareCard}
              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs text-ink-muted hover:text-ink hover:bg-surface rounded-md transition-default focus-ring"
