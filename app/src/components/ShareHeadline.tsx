...
export function ShareHeadline({ data, compact, onCopied }: ShareHeadlineProps) {
  ...
  const handleCopy = async () => {
    try {
      ...
      toast.success(t("shareHeadline.copiedHeadline"));
      onCopied?.();
    } catch {
      toast.error(t("shareHeadline.copyFailed"));
    }
  };
    ...
    return (
      <div className="space-y-2">
        <div className="flex items-center justify-between gap-2">
          <span className="text-xs font-medium text-ink-muted">{t("shareHeadline.shareText")}</span>
          <div
            role="radiogroup"
        ...
        <div className="flex gap-1.5">
          ...
          >
            ...
            {t("shareHeadline.copy")}
          </button>
          <button
            type="button"
            onClick={() => handleShare("twitter")}
            className="px-2 py-1.5 rounded-lg border border-surface bg-surface text-ink hover:bg-surface-raised transition-default"
            title={t("shareHeadline.shareOnX")}
          >
          ...
          <button
            ...
            className="px-2 py-1.5 rounded-lg border border-surface bg-surface text-ink hover:bg-surface-raised transition-default"
            title={t("shareHeadline.shareOnLinkedIn")}
          >
            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          title={t("shareHeadline.shareOnXTwitter")}
        >
          <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
          </svg>
